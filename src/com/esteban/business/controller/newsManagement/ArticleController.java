...
import com.esteban.core.framework.utils.excelPlugin.ExcelKit;
...
public class ArticleController {
	...
	public String list(){
		return "newsManagement/article/list_article";
	}
	...
	public String toAdd(HttpServletRequest request,Model model){
		...
		return "newsManagement/article/add_article";
	}
	...
	public String toEdit(String id,Model model,HttpServletRequest request){
		...
		return "newsManagement/article/edit_article";
	}
