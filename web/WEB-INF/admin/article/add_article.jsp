...
<script type="text/javascript">
	function doSub(){
		...
		$.ajax({
			cache: true,
			type: "POST",
			url:"${basePath}/admin/article/ifm/add",
...
<form action="${basePath }/admin/article/ifm/addArticle" id="myForm">
		...
		<td>
			<table width="100%" align="center" >
				<tr>
					...
					<td>
						<input name="title" id="title" style="width:450px" class="easyui-validatebox textbox validatebox-text" />
					</td>
				</tr>
				<tr>
					<td style="padding-left:10px">作者</td>
					<td>
						<input name="author" id="author" style="width:450px" class="easyui-validatebox textbox validatebox-text"/>
					</td>
				</tr>
				<tr>
					<td style="padding-left:10px">转载地址（可不填）</td>
					<td>
						<input name="fromUrl" id="fromUrl" style="width:450px" class="easyui-validatebox textbox validatebox-text"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						...
						<input name="isTop" type="radio" value="0" checked="checked"/> 否
					</td>
				</tr>
				<tr>
