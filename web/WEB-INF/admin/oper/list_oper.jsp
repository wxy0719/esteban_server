...
$(function(){
	$('#dataTable').datagrid({
		...
		collapsible:true,
		idField: "id", 
		url:'${basePath}/admin/oper/ifm/listOperJSON',
		sortOrder: 'desc',
		remoteSort: false,
		frozenColumns:[[
		...
		toolbar:[{
			...
			handler:function(){
				$('#openWin').html("");
				$('#openWin').append("<iframe src='${basePath}/admin/oper/ifm/toAdd' width='100%' height='99%' frameborder='no' border='0' marginwidth='0' marginheight='0' scrolling='no' allowtransparency='yes'></iframe>");
				$('#openWin').window('open');  
			}
		},{
			id:'btnedit',
			...
			handler:function(){
				...
				$('#openWin').html("");
				$('#openWin').append("<iframe src='${basePath}/admin/oper/ifm/toEdit?id="+row.id+"' width='100%' height='99%' frameborder='no' border='0' marginwidth='0' marginheight='0' scrolling='no' allowtransparency='yes'></iframe>");
				$('#openWin').window('open');  
			}
		},{
			id:'btnactive',
...
function doDel(id){
	$.ajax({
		cache: true,
		type: "POST",
		url:"${basePath}/admin/oper/ifm/del",
		data:{id:id},
		async: false,
