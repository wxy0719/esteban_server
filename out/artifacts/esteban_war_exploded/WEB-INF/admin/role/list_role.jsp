...
$(function(){
	$('#dataTable').datagrid({
		...
		collapsible:true,
		idField: "id", 
		url:'${basePath}/admin/role/ifm/listRoleJSON',
		sortOrder: 'desc',
		remoteSort: false,
		frozenColumns:[[
            {field:'id',checkbox:true},
            {title:'角色名',field:'name',width:120}
		]],
		columns:[[
		...
		toolbar:[{
			...
			handler:function(){
				$('#openWin').html("");
				$('#openWin').append("<iframe src='${basePath}/admin/role/ifm/toAdd' width='100%' height='99%' frameborder='no' border='0' marginwidth='0' marginheight='0' scrolling='no' allowtransparency='yes'></iframe>");
				$('#openWin').window('open');  
			}
		},{
			id:'btnedit',
			...
			handler:function(){
				...
				$('#openWin').html("");
				$('#openWin').append("<iframe src='${basePath}/admin/role/ifm/toEdit?id="+row.id+"' width='100%' height='99%' frameborder='no' border='0' marginwidth='0' marginheight='0' scrolling='no' allowtransparency='yes'></iframe>");
				$('#openWin').window('open');  
			}
		},{
			id:'btnactive',
...
function doDel(id){
	$.ajax({
		cache: true,
		type: "POST",
		url:"${basePath}/admin/role/ifm/del",
		data:{id:id},
		async: false,
